...
**Tests**: Les tests sont OBLIGATOIRES. Chaque story doit inclure des tests de succes,
d'erreur et de warning sur les parcours critiques.
...
- [ ] T010 [P] Mettre en place la base de sécurité (authn/authz, appareils autorisés)
- [ ] T011 [P] Mettre en place la journalisation des événements de sécurité
...
### Tests for User Story 1 (OBLIGATOIRE) ⚠️
...
- [ ] T014 [P] [US1] Unit tests succès/erreur/warning in tests/unit/test_[name].py
...
### Tests for User Story 2 (OBLIGATOIRE) ⚠️
...
- [ ] T023 [P] [US2] Unit tests succès/erreur/warning in tests/unit/test_[name].py
...
### Tests for User Story 3 (OBLIGATOIRE) ⚠️
...
- [ ] T030 [P] [US3] Unit tests succès/erreur/warning in tests/unit/test_[name].py
...
- [ ] TXXX Validation finale de conformité à la constitution
